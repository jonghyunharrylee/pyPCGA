...
'obs_type':['Temperature'],'t_obs_interval':86400.*5.}
...
for i in range(0,10,2):
    ...
    fig.savefig('est_heat_lay%0d.png' % (i))
    #plt.show()
    plt.close(fig)
    ...
    #plt.show()
    fig.savefig('std_heat_layer%d.png' % (i))
    plt.close(fig)
